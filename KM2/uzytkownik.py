...
class Uzytkownik:
    ...
    def zarejestruj(self, nazwa_uzytkownika, email, haslo):
        if not self.polityka_hasel(haslo):
            return False
        ...
        dane = (nazwa_uzytkownika, email, zahashowane_haslo, salt, "pracownik")
    ...
    def zaloguj(self, email, haslo):
        ...
        try:
            ...
            return Uzytkownik(id, nazwa_uzytkownika, email, rola)
        except:
            return False
    ...
    def polityka_hasel(self, haslo):
        if len(haslo)<12:
            print("haslo musi miec minimum 12 znakow!\n")
            return False
        if len(haslo)>128:
            print("haslo nie moze miec wiecej niz 128 znakow!\n")
            return False
        if self.czy_popularne_haslo(haslo):
            print("zbyt popularne haslo!\n")
            return False
        return True
...
class Pracownik(Uzytkownik):
    ...
    def pobierzCzasPracy(self):
        ...
        sql = """
            ...
            ORDER BY id DESC
            """
        return baza.pobierz(sql, (self.id,))

class Administrator(Uzytkownik):
    def zarzadzajDostepem(self):
        return True
    ...
    def wyswietlRaporty(self):
        ...
        for pracownik in pracownicy:
            ...
            raport.append((nazwa, email, czas_pracy))
...
class RejestrCzasu:
    ...
    def obliczCzas(self, godzina_rozpoczecia, godzina_zakonczenia):
        ...
        return round(roznica.total_seconds()/3600, 2)
